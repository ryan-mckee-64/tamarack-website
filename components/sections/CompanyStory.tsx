  ...
  return (
    <section id="company" className="scroll-mt-28 border-t border-[color:var(--line)]">
      <div className="mx-auto max-w-[1280px] px-6 py-24 md:px-10">
        ...
        <h2 className="font-display mt-3 max-w-3xl text-3xl font-extrabold tracking-[-0.03em] text-[color:var(--ink)] sm:text-4xl">
        ...
        <p className="mt-6 max-w-2xl text-lg leading-relaxed text-[color:var(--ink-dim)]">
          We build in Manitoba because we work in Manitoba. Every machine that
          leaves our plant is designed around the reality that a job site does
          not stop for weather, and that equipment which fails in the cold is
          equipment that costs somebody a week.
        </p>
        ...
        <div className="mt-16 grid gap-10 lg:grid-cols-[1fr_1.2fr]">
          <div>
            ...
            <p className="mt-4 text-sm leading-relaxed text-[color:var(--ink-dim)]">
              ...
              That means the person who answers a service call has usually
              stood beside the machine on a line. It also means changes that
              come back from the field reach the next build rather than the next
              model year.
            </p>
            <p className="mt-4 text-sm leading-relaxed text-[color:var(--ink-dim)]">
